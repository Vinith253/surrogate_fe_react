    ...
    <Box>
        ...
        <Box
          sx={{
            width: '423px',
            display: 'flex',
            border:  progress !== 100 ? '2px dashed #f3f3f3': danger?'2px dashed #FDF1F2':'2px dashed #F1F9F3',
            borderColor: '#D2D2D3',
          ...
          <Box sx={{ paddingY: '3px' }}>
            <Typography
              sx={{
                ...
                fontSize: '12px',
                lineHeight: '16px',
                color:  progress !== 100 ? '#0662B7': danger?'#E63946':'#32A64D',
              }}
            >
              {props.title}
            </Typography>
            <Typography
              sx={{
                ...
                color:  progress !== 100 ? 'grey': danger?'#F18F96':'#8BCD9A',
              }}
            >
        ...
        {progress !== 100 ? '': danger?(<Box sx={{display:'flex',justifyContent:'flex-end'}} >
