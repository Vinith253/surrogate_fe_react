...
export const SingleCardFilterDropdown: singleCardFilterInterface[] = [
  {
    label: 'Card Mode',
    option: [
      { code: 'All', name: 'All Mode' },
      { code: 'Salaried', name: 'Salaried' },
      { code: 'Business', name: 'Business' },
      { code: 'Doctor', name: 'Doctor' },
      { code: 'Teacher', name: 'Teacher' },
      { code: 'Defence', name: 'Defence' },
      { code: 'Chartered Accountant', name: 'Chartered Accountant' },
      { code: 'FD Based', name: 'FD Based' },
    ],
  },
  {
    label: 'Card Type',
    option: [
      { code: 'All', name: 'All Type' },
      { code: 'General Basic', name: 'General Basic' },
      { code: 'General Premium', name: 'General Premium' },
      { code: 'General Super Premium', name: 'General Super Premium' },
      { code: 'Co-Brands', name: 'Co-Brands' },
      { code: 'Business Basic', name: 'Business Basic' },
      { code: 'Business Premium', name: 'Business Premium' },
      { code: 'Business Super Premium', name: 'Business Super Premium' },
    ],
  },

  {
    ...
    option: [
      ...
      { code: '1', name: '6 Month' },
      { code: '1', name: '7 Month' },
      { code: '1', name: '10 Month' },
      { code: '1', name: '11 Month' },
      { code: '1', name: '12 Month' },
    ],
  },
];
